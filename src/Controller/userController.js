...
// const updatePasswor = async (req, res) => {
//   try {
//     const { id } = req.user;
//     const { password } = req.body;
//     const user = await User.findById(id);
...
//       res.json(updatedPassword);
//     } else {
//       res.json({ message: "Muafaqiyatli parol o'zgartildi", user });
//     }
//   } catch (error) {
//     console.error(error);
//     res.status(500).json({
//       message: "Ichki server xatosi yuz berdi. Keyinroq qayta urinib ko'ring!",
//     });
//   }
// };
...
//       userCart = new Cart({ userId: _id, items: [] });
//     }
//     if (!userCart) {
...
//     // Bu qatorda savatchani user obyektiga qo'shing
//     const updatedUser = await User.findByIdAndUpdate(
//       _id,
//       { cart: userCart },
//       { new: true }
